...
public class FlightController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Flight> addFlightHandler(@RequestBody Flight flight) {
	 ...
	 */
	@GetMapping
	public ResponseEntity<List<Flight>> getAllFlightsHandler() {
	...
	public ResponseEntity<Flight> getFlightByNameHandler(@PathVariable String flightName) {
	 ...
	 */
	@GetMapping("/{flightId}")
	public ResponseEntity<Flight> getFlightByIdHandler(@PathVariable Integer flightId) {
	 ...
	 */
	@PutMapping("/{flightId}")
	public ResponseEntity<Flight> updateFlightHandler(@PathVariable Integer flightId, @RequestBody Flight flight) {
	...
	public ResponseEntity<Flight> deleteFlightHandler(@PathVariable Integer flightId) {
	...
	public ResponseEntity<List<Flight>> searchFlightsByAirlineHandler(@RequestParam String airlineName) {
